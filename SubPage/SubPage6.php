...
<body>
    ...
    <div class='Middle'>
        <div class='Midbody'>
            <div class='MidHeader'>
                <div class='col1'><img src='/MainMenu/Images/anime6.jpg' class='MidTitleImg'></div>
                <div class='col2'>
                    <h1 class='MidTitleName'>Dragon Ball</h1>
                    <h3 class='MidSubTitleName'>Dragon Ball</h3>
                    <h3 class='MidTitleDate'>1984 - 1995</h3>
                        ...
                        <div class='TabBox'>
                            <div class='subTabBox1'>
                                ...
                                <div class='subTabBoxBody'>
                                    <a href='https://www.iq.com/play/bay-vien-ngoc-rong-z-tap-1-1julstgqzgw?lang=vi_vn'><input type='button' value='1' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/bay-vien-ngoc-rong-z-tap-2-2gos7b0wv2g?lang=vi_vn'><input type='button' value='2' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/bay-vien-ngoc-rong-z-tap-3-czvcakt5ic?lang=vi_vn'><input type='button' value='3' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/bay-vien-ngoc-rong-z-tap-4-e92a1tqjk0?lang=vi_vn'><input type='button' value='4' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/bay-vien-ngoc-rong-z-tap-5-14rq7a4kqbk?lang=vi_vn'><input type='button' value='5' class='EpButton'></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li class='li'>
                        ...
                        <div class='TabBox'>
                            <div class='subTabBox2'>
                                ...
                                <div class='subTabBoxBody'>Rất lâu trước đây, có một truyền thuyết kể rằng có bảy viên ngọc rồng nằm rải rác khắp nơi trên thế giới, chỉ cần thu thập đủ bảy viên ngọc rồng và niệm chú, có thể triệu hồi rồng, bất kể muốn ước nguyện gì đều có thể thành hiện thực.</div>
                            </div>
                        </div>
                    </li>
                    <li class='li'>
