...
<body>
    ...
    <div class='Middle'>
        <div class='Midbody'>
            <div class='MidHeader'>
                <div class='col1'><img src='/MainMenu/Images/anime3.jpg' class='MidTitleImg'></div>
                <div class='col2'>
                    <h1 class='MidTitleName'>MASHLE</h1>
                    <h3 class='MidSubTitleName'>MASHLE</h3>
                    <h3 class='MidTitleDate'>January 2020</h3>
                        ...
                        <div class='TabBox'>
                            <div class='subTabBox1'>
                                ...
                                <div class='subTabBoxBody'>
                                    <a href='https://fptplay.vn/xem-video/mashle-phan-1-65a742869f58a03cb7056cae/tap-1'><input type='button' value='1' class='EpButton'></a>
                                    <a href='https://fptplay.vn/xem-video/mashle-phan-1-65a742869f58a03cb7056cae/tap-2'><input type='button' value='2' class='EpButton'></a>
                                    <a href='https://fptplay.vn/xem-video/mashle-phan-1-65a742869f58a03cb7056cae/tap-3'><input type='button' value='3' class='EpButton'></a>
                                    <a href='https://fptplay.vn/xem-video/mashle-phan-1-65a742869f58a03cb7056cae/tap-4'><input type='button' value='4' class='EpButton'></a>
                                    <a href='https://fptplay.vn/xem-video/mashle-phan-1-65a742869f58a03cb7056cae/tap-5'><input type='button' value='5' class='EpButton'></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li class='li'>
                        ...
                        <div class='TabBox'>
                            <div class='subTabBox2'>
                                ...
                                <div class='subTabBoxBody'>Ngày xửa ngày xưa, có một thế giới nơi phép thuật chi phối mọi thứ. Nhưng sâu trong khu rừng nọ, thanh niên Mash Burnedead lại dành thời gian để chăm chỉ luyện tập cơ bắp. Mặc dù không thể sử dụng phép thuật, nhưng cậu có thể lực vượt trội hơn người và sống bình yên bên cha. Rồi một ngày, Mash nhận ra mình phải trở thành Thần Giác Giả - học viên xuất sắc của Học viện Phép thuật Easton để không bị thủ tiêu. Liệu cơ thể cường tráng có bảo vệ cậu khỏi các loại phép thuật và giành chiến thắng khi đối đầu với các pháp sư không?</div>
                            </div>
                        </div>
                    </li>
                    <li class='li'>
