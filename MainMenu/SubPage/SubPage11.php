...
<body>
    ...
    <div class='Middle'>
        <div class='Midbody'>
            <div class='MidHeader'>
                <div class='col1'><img src='/MainMenu/Images/anime11.jpg' class='MidTitleImg'></div>
                <div class='col2'>
                    <h1 class='MidTitleName'>Fate / Stay Night</h1>
                    <h3 class='MidSubTitleName'>Fate / Stay Night</h3>
                    <h3 class='MidTitleDate'>October 4, 2014</h3>
                        ...
                        <div class='TabBox'>
                            <div class='subTabBox1'>
                                ...
                                <div class='subTabBoxBody'>
                                    <a href='https://www.iq.com/play/fate-zero-tap-1-xuj3aaqqlg?lang=vi_vn'><input type='button' value='1' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/fate-zero-tap-2-1iuyvurwvr4?lang=vi_vn'><input type='button' value='2' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/fate-zero-tap-3-2ce3oh6z7kw?lang=vi_vn'><input type='button' value='3' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/fate-zero-tap-4-12ujg5rlyds?lang=vi_vn'><input type='button' value='4' class='EpButton'></a>
                                    <a href='https://www.iq.com/play/fate-zero-tap-5-26ere0n0q7o?lang=vi_vn'><input type='button' value='5' class='EpButton'></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li class='li'>
                        ...
                        <div class='TabBox'>
                            <div class='subTabBox2'>
                                ...
                                <div class='subTabBoxBody'>Để giành được pháp lực có thể thực hiện kỳ tích của Chén Thánh, bảy pháp sư đã triệu hồi bảy anh linh và tiến hành một cuộc chiến chung cuộc cho đến khi còn lại người cuối cùng mới thôi - Cuộc Chiến Chén Thánh. Sự thật của "Cuộc Chiến Chén Thánh lần IV" xảy ra vào 10 năm trước, bố nuôi của Shirou, bố đẻ của Rin và Kotomine Kirei tuổi trẻ sung sức làm cách nào tham gia cuộc chiến này, mọi thứ sắp được lộ diện.</div>
                            </div>
                        </div>
                    </li>
                    <li class='li'>
                            ...
                            <div class='subTabBox3'>
                                ...
                                <div class='subTabBoxBody'>
                                    ...
                                    <a href='/MainMenu/SubPage/SubPage8.php'><div class='VideoBox'>
                                        ...
                                        <div class='VideoBoxName'>Moonlite Fantasy</div>
                                    </div></a>
                                </div>
                            </div>
                        </div>
